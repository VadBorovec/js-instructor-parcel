...
// const {
//     dress: {pents: favouritePents},
// } = obj;

// console.log(favouritePents); // 'Green Pents'

// const {
//     dress: {boots: favouriteBoots = 'sneakers'},
// } = obj;

// console.log(favouriteBoots); // 'favouriteBoots' || 'sneakers'

// const {
//     jobs: [{ offices: [{ location : officeLocation }] }],
// } = obj;

// console.log(officeLocation); // 'Kyiv'